...
COREWAR_LIBRARIES = -lft -L$(LIBFT_DIRECTORY)
COREWAR_INCLUDES = -I$(HEADERS_DIRECTORY) -I$(LIBFT_HEADERS)

ASM_LIBRARIES = -lft -L$(LIBFT_DIRECTORY)
ASM_INCLUDES = -I$(HEADERS_DIRECTORY) -I$(LIBFT_HEADERS)
...
$(COREWAR_NAME): $(LIBFT) $(COREWAR_OBJECTS_DIRECTORY) $(VS_OBJECTS_DIRECTORY) $(COREWAR_OBJECTS) $(VS_OBJECTS)
...
$(LIBFT):
	@echo "$(COREWAR_NAME): $(GREEN)Creating $(LIBFT)...$(RESET)"
...
fclean: clean
	@rm -f $(LIBFT)
	@echo "$(COREWAR_NAME): $(RED)$(LIBFT) was deleted$(RESET)"
	@rm -f $(ASM_NAME)
